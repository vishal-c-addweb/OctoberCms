 ...
 */
class RevisionHistories extends Controller
{
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Saurabhdhariwal.RevisionHistories', 'revisionhistories', 'revisionhistories');
    }

    public function revisionDetails($id,$modelName){
        return Redirect::to('/backend/saurabhdhariwal/revisionhistory/revisionhistories/revisions/?id='.$id.'&modelName='.$modelName);
    }
